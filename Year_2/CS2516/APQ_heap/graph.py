    ...
    def central_vertex_search(self):
        ...
        for key in self.vertices():
            ...
            if max_path < min_longest_path:
                ...
                central_key = key
        return "central vertex is:" + str(central_key)
...
def test_graph3():
    ...
    for key in vlist:
        print(key, vlist[key])
    print('----------- End of breadth first search')
...
def process_usa():
    ...
    print('Breadth first search:')
    vlist = graph.adaptedbreadthfirstsearch(hdv)
    for key in vlist:
        print(key, vlist[key])
    print('----------- End of breadth first search')

    print('central vertex search:')
    print(graph.central_vertex_search())
    print('----------- End of central vertex search')
