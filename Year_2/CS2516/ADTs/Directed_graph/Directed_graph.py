...
class DGraph:
    ...
    # Implement as *two* Python dictionaries
    ...
    def get_vertex_by_label(self, element):
        ...
        # Note: this is ineffecient (linear search) if we graph is large
        for v in self._structure:
...
directed_graph = graphreader("simplegraph1.txt")
print()


print("The out edges of vertex 3:")
v3 = directed_graph.get_vertex_by_label(3)
print(directed_graph.get_outedges(v3))
print()


print("The topological sort is:")
print(directed_graph.topological_sort())
print()
